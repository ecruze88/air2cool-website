...
const countyTowns = (townsData as { towns: Town[] }).towns.filter(
  (t) => t.countySlug === "union-county"
);

export const metadata: Metadata = {
  title: "Union County HVAC Service | Air2Cool Heating & Cooling",
  description:
    "Air2Cool serves Union County, NJ — AC repair, furnace installation & 24/7 HVAC in Elizabeth, Westfield, Summit, Cranford, Union, Linden and more. PSE&G service area. Call (201) 787-5657.",
  alternates: { canonical: "https://www.air2cool.com/service-areas/union-county" },
};
    ...
    <main className="bg-white">
      <section className="bg-gradient-to-br from-blue-900 via-blue-800 to-blue-900 text-white py-14 md:py-20">
        <div className="max-w-4xl mx-auto px-6 text-center">
          <div className="inline-flex items-center gap-2 bg-blue-600/70 border border-blue-400/30 px-3 py-1.5 rounded-full text-sm font-semibold mb-4">
            <MapPin className="w-4 h-4" /> Union County, NJ
          </div>
      ...
      <section className="py-10 md:py-14 bg-white">
        <div className="max-w-4xl mx-auto px-6">
          <h2 className="text-2xl md:text-3xl font-extrabold text-gray-900 mb-5">
            Why Union County Trusts Air2Cool
          </h2>
      ...
      <section className="py-12 bg-gradient-to-r from-blue-700 to-blue-600 text-white">
        <div className="max-w-3xl mx-auto px-6 text-center">
          <h2 className="text-2xl md:text-4xl font-extrabold mb-4">Ready to Book in Union County?</h2>
