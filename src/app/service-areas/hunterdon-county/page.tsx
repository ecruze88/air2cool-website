...
const countyTowns = (townsData as { towns: Town[] }).towns.filter(
  (t) => t.countySlug === "hunterdon-county"
);

export const metadata: Metadata = {
  title: "Hunterdon County HVAC Service | Air2Cool Heating & Cooling",
  description:
    "Air2Cool serves Hunterdon County, NJ — AC repair, furnace installation & 24/7 HVAC in Flemington, Clinton, Lambertville, High Bridge, Readington and more. JCP&L service area. Call (201) 787-5657.",
  alternates: { canonical: "https://www.air2cool.com/service-areas/hunterdon-county" },
};
      ...
      <section className="bg-gradient-to-br from-blue-900 via-blue-800 to-blue-900 text-white py-14 md:py-20">
        <div className="max-w-4xl mx-auto px-6 text-center">
          <div className="inline-flex items-center gap-2 bg-blue-600/70 border border-blue-400/30 px-3 py-1.5 rounded-full text-sm font-semibold mb-4">
            <MapPin className="w-4 h-4" /> Hunterdon County, NJ
          </div>
          <h1 className="text-3xl md:text-5xl font-extrabold mb-4 leading-tight">
            HVAC Service Across Hunterdon County
          </h1>
          <p className="text-blue-100 text-base md:text-xl mb-8 max-w-2xl mx-auto">
            Flemington, Clinton, Lambertville, High Bridge, Readington and throughout Hunterdon County — Air2Cool provides trusted HVAC service to homes and businesses. JCP&L service area.
          </p>
