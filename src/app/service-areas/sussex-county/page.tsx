...
const countyTowns = (townsData as { towns: Town[] }).towns.filter(
  (t) => t.countySlug === "sussex-county"
);

export const metadata: Metadata = {
  title: "Sussex County HVAC Service | Air2Cool Heating & Cooling",
  description:
    "Air2Cool serves all of Sussex County, NJ — AC repair, furnace installation, heating service & 24/7 emergency HVAC in Newton, Sparta, Vernon, Hopatcong and more. Call (201) 787-5657.",
  alternates: { canonical: "https://www.air2cool.com/service-areas/sussex-county" },
};
    ...
    <main className="bg-white">
      <section className="bg-gradient-to-br from-blue-900 via-blue-800 to-blue-900 text-white py-14 md:py-20">
        <div className="max-w-4xl mx-auto px-6 text-center">
          <div className="inline-flex items-center gap-2 bg-blue-600/70 border border-blue-400/30 px-3 py-1.5 rounded-full text-sm font-semibold mb-4">
            <MapPin className="w-4 h-4" /> Sussex County, NJ
          </div>
          <h1 className="text-3xl md:text-5xl font-extrabold mb-4 leading-tight">
            HVAC Service Across Sussex County
          </h1>
          <p className="text-blue-100 text-base md:text-xl mb-8 max-w-2xl mx-auto">
            ...
            1998. JCP&amp;L service area covered. Licensed &amp; insured — NJ Master HVACR License #19HC00847000. 300+ 5-Star Google Reviews.
          </p>
      ...
      <section className="py-10 md:py-14 bg-gray-50">
        <div className="max-w-5xl mx-auto px-6">
          <h2 className="text-2xl md:text-3xl font-extrabold text-gray-900 mb-6 text-center">
            HVAC Services in Sussex County
          </h2>
      ...
      <section className="py-10 md:py-14 bg-white">
        <div className="max-w-4xl mx-auto px-6">
          <h2 className="text-2xl md:text-3xl font-extrabold text-gray-900 mb-5">
            Why Sussex County Trusts Air2Cool
          </h2>
          <div className="text-gray-700 space-y-4 text-sm md:text-base leading-relaxed">
            <p>
              Sussex County is home to lake communities like Hopatcong and Sparta, rural townships,
              and the county seat of Newton. Air2Cool has been serving the area since 1998, covering
              the entire JCP&L service territory across northern Sussex County.
            </p>
            <p>
              Our techs understand the challenges of older homes in rural Sussex — seasonal heating
              demands, well water compatibility with humidifiers, and the importance of a furnace
              that doesn&apos;t quit at 4 AM in January. We&apos;re on call 24/7.
            </p>
            <p>
      ...
      <section className="py-12 bg-gradient-to-r from-blue-700 to-blue-600 text-white">
        <div className="max-w-3xl mx-auto px-6 text-center">
          <h2 className="text-2xl md:text-4xl font-extrabold mb-4">Ready to Book in Sussex County?</h2>
