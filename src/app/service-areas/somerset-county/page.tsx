...
const countyTowns = (townsData as { towns: Town[] }).towns.filter(
  (t) => t.countySlug === "somerset-county"
);

export const metadata: Metadata = {
  title: "Somerset County HVAC Service | Air2Cool Heating & Cooling",
  description:
    "Air2Cool serves Somerset County, NJ — AC repair, furnace installation & 24/7 HVAC in Somerville, Bridgewater, Bernardsville, Basking Ridge, Hillsborough and more. Call (201) 787-5657.",
  alternates: { canonical: "https://www.air2cool.com/service-areas/somerset-county" },
};

export default function SomersetCountyPage() {
  return (
      ...
      <section className="bg-gradient-to-br from-blue-900 via-blue-800 to-blue-900 text-white py-14 md:py-20">
        <div className="max-w-4xl mx-auto px-6 text-center">
          <div className="inline-flex items-center gap-2 bg-blue-600/70 border border-blue-400/30 px-3 py-1.5 rounded-full text-sm font-semibold mb-4">
            <MapPin className="w-4 h-4" /> Somerset County, NJ
          </div>
          <h1 className="text-3xl md:text-5xl font-extrabold mb-4 leading-tight">
            HVAC Service Across Somerset County
          </h1>
          <p className="text-blue-100 text-base md:text-xl mb-8 max-w-2xl mx-auto">
            Somerville, Bridgewater, Bernardsville, Basking Ridge, Hillsborough and throughout Somerset County — Air2Cool brings expert HVAC service to your door. JCP&L and PSE&G service areas covered.
          </p>
      ...
      <section className="py-10 md:py-14 bg-gray-50">
        <div className="max-w-5xl mx-auto px-6">
          <h2 className="text-2xl md:text-3xl font-extrabold text-gray-900 mb-6 text-center">
            HVAC Services in Somerset County
          </h2>
      ...
      <section className="py-10 md:py-14 bg-white">
        <div className="max-w-4xl mx-auto px-6">
          <h2 className="text-2xl md:text-3xl font-extrabold text-gray-900 mb-5">
            Why Somerset County Trusts Air2Cool
          </h2>
