...
const countyTowns = (townsData as { towns: Town[] }).towns.filter(
  (t) => t.countySlug === "passaic-county"
);

export const metadata: Metadata = {
  title: "Passaic County HVAC Service | Air2Cool Heating & Cooling",
  description:
    "Air2Cool serves Passaic County, NJ — AC repair, furnace installation & 24/7 HVAC in Paterson, Clifton, Wayne, Hawthorne, West Milford and more. Call (201) 787-5657.",
  alternates: { canonical: "https://www.air2cool.com/service-areas/passaic-county" },
};
      ...
      <section className="bg-gradient-to-br from-blue-900 via-blue-800 to-blue-900 text-white py-14 md:py-20">
        <div className="max-w-4xl mx-auto px-6 text-center">
          <div className="inline-flex items-center gap-2 bg-blue-600/70 border border-blue-400/30 px-3 py-1.5 rounded-full text-sm font-semibold mb-4">
            <MapPin className="w-4 h-4" /> Passaic County, NJ
          </div>
          <h1 className="text-3xl md:text-5xl font-extrabold mb-4 leading-tight">
            HVAC Service Across Passaic County
          </h1>
          <p className="text-blue-100 text-base md:text-xl mb-8 max-w-2xl mx-auto">
            Paterson, Wayne, Clifton, Ringwood, West Milford and everything in between — Air2Cool
            serves all of Passaic County. Both PSE&G and JCP&L service areas covered.
          </p>
      ...
      <section className="py-12 md:py-16">
        <div className="max-w-6xl mx-auto px-6">
          <h2 className="text-2xl md:text-4xl font-extrabold text-gray-900 text-center mb-3">
            Towns We Serve in Passaic County
          </h2>
      ...
      <section className="py-10 md:py-14 bg-white">
        <div className="max-w-4xl mx-auto px-6">
          <h2 className="text-2xl md:text-3xl font-extrabold text-gray-900 mb-5">
            Why Passaic County Trusts Air2Cool
          </h2>
          <div className="text-gray-700 space-y-4 text-sm md:text-base leading-relaxed">
            <p>
              Passaic County stretches from the densely urban areas of Paterson and Clifton to the
              forested highlands of West Milford and Ringwood. Air2Cool has been servicing this
              diverse landscape since 1998 — handling high-rise building systems, suburban
