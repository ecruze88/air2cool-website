...
export default function ACRepairPage() {
  return (
    <main className="bg-white">
      {/* Hero Section */}
      <section className="relative bg-linear-to-br from-blue-900 via-cyan-800 to-blue-800 text-white overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="relative">
              <div className="bg-linear-to-br from-blue-100 to-cyan-100 rounded-3xl p-8">
                {/* Placeholder - replace with actual image */}
                <div className="rounded-2xl bg-linear-to-br from-blue-600 to-cyan-600 aspect-4/3 flex items-center justify-center shadow-lg">
                  <Snowflake className="w-32 h-32 text-white opacity-20" />
                </div>
              </div>
            </div>
          </div>
      ...
      <section className="py-12 bg-slate-900 text-white">
        <div className="max-w-4xl mx-auto px-6 text-center">
          ...
          <p className="text-gray-300">
            Ask about our flexible financing options to make your AC repair affordable.
          </p>
        </div>
      </section>
    </main>
