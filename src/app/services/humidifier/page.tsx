...
export default function HumidifierPage() {
  return (
    <main className="bg-white">
      {/* Hero */}
      <section className="relative bg-linear-to-br from-cyan-900 via-blue-800 to-cyan-800 text-white overflow-hidden py-20">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div>
              ...
              <div className="flex flex-wrap gap-4 mb-8">
                <Link
                  href="/contact"
                  className="bg-white text-cyan-700 px-8 py-4 rounded-full font-bold text-lg shadow-lg hover:bg-gray-50 transition-all"
                >
                  Get Free Estimate
                </Link>
                <a
            ...
            <div className="bg-white/10 backdrop-blur rounded-3xl p-8 border border-white/20">
              <div className="bg-white rounded-2xl p-6">
                <div className="text-center">
                  <h3 className="text-2xl font-bold text-gray-900 mb-2">Aprilaire 865</h3>
                  <p className="text-gray-600 mb-4">Ductless Steam Humidifier Package</p>
        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="grid md:grid-cols-3 gap-8 mb-12">
            <div className="bg-white rounded-2xl p-8 shadow-lg border-2 border-red-100">
              ...
              <h3 className="text-xl font-bold text-gray-900 mb-3">Health Issues</h3>
            ...
            <div className="bg-white rounded-2xl p-8 shadow-lg border-2 border-orange-100">
              ...
              <h3 className="text-xl font-bold text-gray-900 mb-3">Home Damage</h3>
              <ul className="space-y-2 text-gray-600">
                <li className="flex items-start gap-2">
            ...
            <div className="bg-white rounded-2xl p-8 shadow-lg border-2 border-blue-100">
              ...
              <h3 className="text-xl font-bold text-gray-900 mb-3">Higher Costs</h3>
              <ul className="space-y-2 text-gray-600">
                <li className="flex items-start gap-2">
          ...
          <div className="text-center bg-cyan-50 rounded-2xl p-8 border-2 border-cyan-200">
            ...
            <div className="bg-gradient-to-br from-cyan-50 to-blue-50 rounded-2xl p-8 border-2 border-cyan-200">
              ...
              <div className="space-y-3">
                <div className="flex items-center gap-3 pb-3 border-b border-cyan-200">
                  <span className="font-semibold text-gray-900 w-32">Coverage:</span>
                  <span className="text-gray-700">Up to 3,400 sq ft</span>
                </div>
                <div className="flex items-center gap-3 pb-3 border-b border-cyan-200">
                  <span className="font-semibold text-gray-900 w-32">Output:</span>
                  <span className="text-gray-700">11.5 gallons/day</span>
                </div>
                <div className="flex items-center gap-3 pb-3 border-b border-cyan-200">
                  <span className="font-semibold text-gray-900 w-32">Type:</span>
                  <span className="text-gray-700">Steam (electrode)</span>
                </div>
                <div className="flex items-center gap-3 pb-3 border-b border-cyan-200">
                  <span className="font-semibold text-gray-900 w-32">Installation:</span>
                  <span className="text-gray-700">Ductless</span>
                </div>
                <div className="flex items-center gap-3 pb-3 border-b border-cyan-200">
                  <span className="font-semibold text-gray-900 w-32">Control:</span>
                  <span className="text-gray-700">Digital thermostat</span>
                </div>
                <div className="flex items-center gap-3 pb-3 border-b border-cyan-200">
                  <span className="font-semibold text-gray-900 w-32">Noise:</span>
                  <span className="text-gray-700">Whisper-quiet</span>
                </div>
                <div className="flex items-center gap-3">
                  <span className="font-semibold text-gray-900 w-32">Warranty:</span>
                  <span className="text-gray-700">5-year factory</span>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="max-w-4xl mx-auto px-6 text-center">
          ...
          <div className="grid sm:grid-cols-3 gap-6 mb-12">
            ...
            <div className="bg-white rounded-xl p-6 shadow-lg">
              ...
              <h3 className="font-bold text-gray-900 mb-2">Expert Install</h3>
              <p className="text-sm text-gray-600">
            ...
            <div className="bg-white rounded-xl p-6 shadow-lg">
              ...
              <h3 className="font-bold text-gray-900 mb-2">Testing & Training</h3>
              <p className="text-sm text-gray-600">
          ...
          <Link
            href="/contact"
            className="inline-block bg-cyan-600 hover:bg-cyan-700 text-white px-10 py-5 rounded-full font-bold text-lg shadow-lg transition-all hover:scale-105"
          >
