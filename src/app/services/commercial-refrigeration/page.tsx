...
export default function CommercialRefrigerationPage() {
  return (
    <main className="bg-white">
      {/* Hero */}
      <section className="relative bg-gradient-to-br from-slate-900 via-blue-900 to-slate-800 text-white overflow-hidden py-20">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6">
          <div className="max-w-4xl">
            ...
            <div className="flex flex-wrap gap-4 mb-8">
              <Link
                href="/contact"
                className="bg-blue-600 hover:bg-blue-700 text-white px-8 py-4 rounded-full font-bold text-lg shadow-lg transition-all"
              >
        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="bg-white rounded-xl p-6 shadow-lg border-2 border-gray-200">
              ...
              <h3 className="text-xl font-bold text-gray-900 mb-2">Code-Compliant</h3>
            ...
            <div className="bg-white rounded-xl p-6 shadow-lg border-2 border-gray-200">
              <CheckCircle className="w-10 h-10 text-blue-600 mb-4" />
              <h3 className="text-xl font-bold text-gray-900 mb-2">Proper Mounting</h3>
              <p className="text-gray-600">
            ...
            <div className="bg-white rounded-xl p-6 shadow-lg border-2 border-gray-200">
              <CheckCircle className="w-10 h-10 text-blue-600 mb-4" />
              <h3 className="text-xl font-bold text-gray-900 mb-2">Minimal Downtime</h3>
              <p className="text-gray-600">
        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="bg-gradient-to-br from-blue-50 to-cyan-50 rounded-xl p-6 border-2 border-blue-200">
              ...
              <h3 className="text-xl font-bold text-gray-900 mb-3">Rooftop Units (RTUs)</h3>
            ...
            <div className="bg-gradient-to-br from-cyan-50 to-blue-50 rounded-xl p-6 border-2 border-cyan-200">
              <Wrench className="w-10 h-10 text-cyan-600 mb-4" />
              <h3 className="text-xl font-bold text-gray-900 mb-3">Commercial Refrigeration</h3>
              <ul className="space-y-2 text-sm text-gray-700">
                <li className="flex items-start gap-2">
            ...
            <div className="bg-gradient-to-br from-indigo-50 to-blue-50 rounded-xl p-6 border-2 border-indigo-200">
              ...
              <h3 className="text-xl font-bold text-gray-900 mb-3">Commercial HVAC</h3>
              <ul className="space-y-2 text-sm text-gray-700">
                <li className="flex items-start gap-2">
      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            <div className="bg-white rounded-xl p-6 shadow-md text-center">
              <Home className="w-12 h-12 text-cyan-600 mx-auto mb-3" />
              <h3 className="font-bold text-gray-900 mb-2">Retail Stores</h3>
              <p className="text-sm text-gray-600">
      ...
      <section className="py-16 bg-gradient-to-r from-red-600 to-orange-600 text-white">
        <div className="max-w-4xl mx-auto px-6 text-center">
          ...
          <a
            href="tel:+12017875657"
            className="inline-flex items-center gap-2 bg-white text-red-700 px-10 py-5 rounded-full font-bold text-lg shadow-lg hover:bg-gray-50 transition-all"
          >
      ...
      <section className="py-20 bg-white">
        <div className="max-w-4xl mx-auto px-6 text-center">
          ...
          <div className="flex flex-wrap items-center justify-center gap-4">
            <Link
              href="/contact"
              className="bg-blue-600 hover:bg-blue-700 text-white px-10 py-5 rounded-full font-bold text-lg shadow-lg transition-all hover:scale-105"
            >
              Request Service Quote →
            </Link>
            <a
